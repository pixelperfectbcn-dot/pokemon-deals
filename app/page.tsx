...
const sourceStatus = [
  ...
  { name: "Filtros estrictos", status: "Ready", detail: "Solo Pokémon, solo con precio y solo tipos válidos" },
  { name: "Fallback dummy", status: "Ready", detail: "Si la tienda falla, el sistema sigue funcionando" },
...
export default function HomePage() {
  ...
  async function triggerRefresh() {
    try {
      ...
      setLastRefreshMessage(data.message ?? "");
      await loadAll();
    } catch (error) {
            ...
            <div className="grid gap-6 p-6 md:grid-cols-3 md:p-8">
              <div className="space-y-4 md:col-span-2">
                <div className="flex items-center gap-2 text-sm text-slate-600">
                  ...
                  Fase 8: tienda oficial de JCC Pokémon en Amazon España
                </div>

                <h1 className="text-3xl font-semibold tracking-tight md:text-5xl">Pokemon Deals Radar</h1>

                <p className="max-w-2xl text-base text-slate-600 md:text-lg">
                  El refresh usa solo la tienda oficial de Pokémon en Amazon España. Después filtra
                  estrictamente para quedarse con productos Pokémon, con precio visible y tipos válidos.
                </p>

                <div className="flex flex-wrap gap-2 pt-2">
                  <Badge>Tienda oficial</Badge>
                  <Badge>Solo Pokémon</Badge>
                  <Badge>Solo con precio</Badge>
                  <Badge>Tipos válidos</Badge>
                </div>
            ...
            {tab === "history" && (
              <div className="grid gap-4">
                {loading ? (
                  ...
                  <Card className="p-5">
                    <div className="text-slate-500">Aún no hay snapshots. Pulsa "Actualizar tienda oficial".</div>
                  </Card>
                ) : (
                  history.map((item) => (
              ...
              <div className="grid gap-4 xl:grid-cols-2">
                <Card className="p-5">
                  ...
                  <div className="space-y-3 text-slate-700">
                    ...
                    <p>El refresh muestra el mensaje devuelto por la API.</p>
                    <p>La búsqueda está normalizada sin problema de tildes.</p>
                  </div>
                </Card>
                ...
                <Card className="p-5">
                  ...
                  <div className="space-y-3 text-slate-700">
                    <p>POST /api/refresh intenta la tienda oficial y cae a dummy si falla.</p>
                    <p>El scraper filtra solo productos Pokémon con precio y tipos válidos.</p>
                    <p>Los cambios de precio se persisten automáticamente.</p>
                  </div>
                </Card>
                ...
                <Card className="p-5">
                  <SectionTitle icon={<TrendingDown className="h-4 w-4" />} title="Variables" />
                  <div className="space-y-3 text-slate-700">
                    <p>Controlas la URL de tienda, el límite y los tipos válidos desde variables.</p>
                    <p>No tienes que tocar código para ajustar el filtro.</p>
                    <p>La tienda objetivo queda fijada en AMAZON_STORE_URL.</p>
                  </div>
                </Card>
              </div>
            )}
