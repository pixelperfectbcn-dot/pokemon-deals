...
const sourceStatus = [
  { name: "Amazon scrape", status: "Online", detail: "Refresh intenta leer búsquedas de Amazon directamente" },
  { name: "Fallback dummy", status: "Ready", detail: "Si Amazon falla o devuelve captcha, el sistema sigue funcionando" },
            ...
            <div className="grid gap-6 p-6 md:grid-cols-3 md:p-8">
              <div className="space-y-4 md:col-span-2">
                <div className="flex items-center gap-2 text-sm text-slate-600">
                  ...
                  Fase 7: scraping directo de Amazon + fallback automático
                </div>

                <h1 className="text-3xl font-semibold tracking-tight md:text-5xl">Pokemon Deals Radar</h1>

                <p className="max-w-2xl text-base text-slate-600 md:text-lg">
                  El refresh intenta leer búsquedas de Amazon directamente. Si Amazon devuelve captcha,
                  HTML inesperado o no hay resultados con precio, el sistema usa fallback dummy.
                </p>

                <div className="flex flex-wrap gap-2 pt-2">
                  <Badge>Amazon scrape</Badge>
                  <Badge>Fallback dummy</Badge>
          ...
          <Card className="p-5 lg:col-span-1">
            ...
            <div className="space-y-4">
              ...
              <button onClick={triggerRefresh} disabled={refreshing} className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-slate-900 px-4 py-3 text-sm font-medium text-white hover:bg-slate-800 disabled:opacity-60">
                ...
                {refreshing ? "Actualizando..." : "Actualizar Amazon"}
              </button>
            </div>
          </Card>
            ...
            {tab === "history" && (
              <div className="grid gap-4">
                {loading ? (
                  ...
                  <Card className="p-5">
                    <div className="text-slate-500">Aún no hay snapshots. Pulsa "Actualizar Amazon".</div>
                  </Card>
                ) : (
                  history.map((item) => (
            ...
            {tab === "architecture" && (
              <div className="grid gap-4 xl:grid-cols-2">
                ...
                <Card className="p-5">
                  ...
                  <div className="space-y-3 text-slate-700">
                    <p>POST /api/refresh intenta scraping de Amazon y cae a dummy si falla.</p>
                ...
                <Card className="p-5">
                  ...
                  <div className="space-y-3 text-slate-700">
                    <p>Añadir worker separado.</p>
                    <p>Implementar rotación de consultas y control de bloqueos.</p>
